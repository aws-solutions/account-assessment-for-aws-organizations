...
import {SearchForm, LastSearchParams} from "./SearchForm"
import {PolicyExplorerTable, ContentDisplayOption} from "./PolicyExplorerTable"
...
export const PolicyExplorerPage = () => {
  ...
  const [contentDisplayOption, setContentDisplayOption] = useState<ContentDisplayOption[]>(contentDisplayItems);
  const [lastSearchParams, setLastSearchParams] = useState<LastSearchParams | undefined>(undefined);
  ...
  return (
    ...
    >
      <SpaceBetween size={"l"}>
        <SearchForm
          onSearchParamsChange={setLastSearchParams}
        ></SearchForm>
        <PolicyExplorerTable
