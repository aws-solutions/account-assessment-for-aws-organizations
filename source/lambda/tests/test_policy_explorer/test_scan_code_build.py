...
def test_mock_codebuild_scan_policy(mocker):
    ...
    list_report_groups_response: list[str] = ['arn:aws:codebuild:us-east-1:1111:report-group/test-report-group']
    batch_get_projects_response: list[ProjectTypeDef] = [
        {
            'name': 'test-codebuild-project',
            'arn': 'arn:aws:codebuild:us-east-1:1111:project/test-codebuild-project',
            'source': {},
            'secondarySources': [],
            ...
            'serviceRole':
                'arn:aws:iam::1111:role/service-role/codebuild-test-codebuild-service'
                '-role',
            'timeoutInMinutes': 60,
